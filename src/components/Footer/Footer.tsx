                ...
                <div>
                    <div className="flex items-center justify-between mb-[40px]">
                        ...
                        <div className="flex gap-x-[20px]">
                            <span className="bg-white p-[10px] rounded-[20px] font-medium text-[#666]">94 070 04 08</span>
                            <span className="bg-white p-[10px] rounded-[20px] font-medium text-[#666]">Toshkent</span>
